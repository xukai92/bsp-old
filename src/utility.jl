...
import BayesianSymbolic: compute_logjoint
import FileIO: save
...
function compute_logjoint(ScenarioModel, worlds, latents, getforce::Function, like)
...
function compute_normrmse(ScenarioModel, worlds, latents, getforce::Function, like)
